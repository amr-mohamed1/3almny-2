<?php
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])){
        $material_id = $_GET['id'];
            if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST["lec_no"]) && !empty($_POST["space"]) )
            {
                ...
                $doc = $_POST["doc"];
                $filter = $_POST["filter"];
                updateMaterial($material_id , $subject , $lec_no ,$space ,$view ,$download ,$date ,$doc ,$filter);
            }
            $result = getMaterial_with_id($material_id);
...
<form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
  ...
  <div class="form-group col-md-3 mb-3">
      ...
      <select class="custom-select"  name="subject" id="validationCustom04" required>
        ...
        <div class="form-group col-md-12">
            ...
            <input style="direction: ltr;" name="lec_no" type="text" value="<?php echo $result['lecture_number'] ?>" class="form-control">
        </div>
        <div class="form-group col-md-12">
            <label>file space</label>
            <input style="direction: ltr;" name="space" value="<?php echo $result['space'] ?>" type="text" class="form-control">
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <input style="direction: ltr;" name="download" value="<?php echo $result['download_link'] ?>" type="text" class="form-control">
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <input style="direction: ltr;" name="doc" value="<?php echo $result['doctor'] ?>" type="text" class="form-control">
        </div>
        <div class="form-group col-md-3 mb-3">
      <label for="validationCustom04">Enter subject code</label>
  ...
  <a class="btn btn-secondary pr-4 pl-4 ml-3" href="update_material.php">Back</a>
</form>
</div>
